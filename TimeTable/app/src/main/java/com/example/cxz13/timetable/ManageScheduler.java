...
public class ManageScheduler extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manage_scheduler);
        ...
        btget.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (editid.getText().toString().equals("")) {
                    Toast.makeText(ManageScheduler.this, "Please enter id", Toast.LENGTH_SHORT).show();
                } else {
                    //initialized sqlitehelper class.
                    sqlHelper = new sqlHelper(ManageScheduler.this);
